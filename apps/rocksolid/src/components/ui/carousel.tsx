...
export const CarouselIndicatorGroup = withContext(styled(Ark.CarouselIndicatorGroup), 'indicatorGroup');
export const CarouselNextSlideTrigger = withContext(styled(Ark.CarouselNextSlideTrigger), 'nextSlideTrigger');
export const CarouselPrevSlideTrigger = withContext(styled(Ark.CarouselPrevSlideTrigger), 'prevSlideTrigger');
